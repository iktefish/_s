fn main() {
    ...
    let (slice1, slice2) = first_three(&numbers, &other_numbers); // DONE
...
fn first_three<'a>(numbers1: &'a Vec<i64>, numbers2: &'a Vec<i64>) -> (&'a [i64], &'a [i64]) { // DONE
    ...
    let f3_n1 = &numbers1[0..3];
    let f3_n2 = &numbers2[0..3];
    (f3_n1, f3_n2) // DONE
}
